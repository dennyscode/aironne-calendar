...
export function show_next_month() {    calendar_switch_month("next", date); console.log("FUNCTION OUTCOME (NEXT): " + date)    };

export function show_prev_month() {    calendar_switch_month("prev", date); console.log("FUNCTION OUTCOME (PREV): " + date)    };

let startdate = date;

 export function show_calendar(options) {
    let input_date = options.date;
